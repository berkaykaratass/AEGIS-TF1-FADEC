...
# Check a few stiff configurations
configs = [
    # lp_do, lp_di, hp_do, hp_di, k_lp, k_hp, k_is
    (0.040, 0.028, 0.054, 0.042, 1.2e8, 14.0e8, 5.0e8),
    (0.042, 0.030, 0.056, 0.044, 1.2e8, 14.0e8, 5.0e8),
    (0.044, 0.032, 0.058, 0.046, 1.2e8, 14.0e8, 5.0e8),
    (0.046, 0.034, 0.060, 0.048, 1.2e8, 14.0e8, 5.0e8),
    (0.048, 0.036, 0.062, 0.050, 1.2e8, 14.0e8, 5.0e8),
]

for idx, c in enumerate(configs):
    safe, crits, mb, ma = run_eval(*c)
    print(f"Config {idx+1}: safe={safe}, crits={crits}, margin_below={mb:.1f}%, margin_above={ma:.1f}%")
